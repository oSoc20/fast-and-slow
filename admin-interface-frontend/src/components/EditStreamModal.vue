                    ...
                    <vl-form-grid>
                        <vl-form-validation-observer slim v-slot="{handleSubmit, errors, invalid}">
                            ...
                            <vl-column>
                                ...
                                <vl-form-validation rules="required" name="New event strean name"
                                ...
                                <vl-form-message-annotation>This will change the name for every fragmentation. The old
                                    URI
                                    will still work.
                            ...
                            <vl-action-group mod-space-between>
                                ...
                                <vl-action-group mod-align-right>
                                    <vl-button @click="emptyFields" mod-secondary
                                               v-vl-modal-toggle="'editstream-modal'">Cancel
                                    </vl-button>
                                    <vl-button v-if="invalid" mod-disabled v-vl-modal-toggle="'editstream-modal'">Save
                                    </vl-button>
                                    <vl-button v-else @click="updateStreamName" v-vl-modal-toggle="'editstream-modal'">
                                        Save
                                    </vl-button>
                                </vl-action-group>
                            </vl-action-group>
